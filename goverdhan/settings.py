"""
Django settings for goverdhan project.
...
ROOT_URLCONF = 'goverdhan.urls'
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'goverdhan/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'goverdhan.wsgi.application'
